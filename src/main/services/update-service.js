    ...
    try {
      ...
      if (versionComparison > 0) {
        lastEvaluatedGate = {
          ...
          detail: "Kliknij Zaktualizuj, aby pobrać najnowszy instalator.",
          allowInstall: true,
          allowRetry: true,
          manifest,
        };
      ...
      if (
        ...
        lastEvaluatedGate = {
          ...
          localAppSha256,
          message:
            "Nie udało się zapisać i potwierdzić wersji aplikacji w lokalnej bazie danych.",
      ...
      if (
        ...
        lastEvaluatedGate = {
          ...
          localAppSha256,
          message:
            "Nie udało się połączyć z serwerem aktualizacji. Używam ostatniej potwierdzonej wersji lokalnej.",
      ...
      lastEvaluatedGate = {
        ...
        remoteVersion: "",
        localAppSha256,
        message: "Nie udało się potwierdzić wersji aplikacji na serwerze.",
        detail: error.message,
        allowInstall: false,
        allowRetry: true,
        manifest: null,
